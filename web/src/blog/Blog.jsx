...
function Footer({locale}){return <footer className="blog-footer"><span>© {new Date().getFullYear()} GANU</span><a href="mailto:merhaba@ganu.com.tr">{copy[locale].contact}</a></footer>}
